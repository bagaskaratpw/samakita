															...
															<tbody>
																...
																<tr>
																	<td style="text-align : center;">
																		<?php echo $barang['id_barang'];?> </td>
																	<td style="text-align : center;">
																		<?php echo $barang['nama_barang'];?></td>
																	<td style="text-align : center;">
																		<?php echo $barang['unit'];?></td>
																	<td style="text-align : center;">
																		<?php echo $barang['harga'];?></td>
																	<td style="text-align : center;">
																		<a href="<?php echo base_url('Welcome/hapus_barang/').$barang['id_barang'];?>"
